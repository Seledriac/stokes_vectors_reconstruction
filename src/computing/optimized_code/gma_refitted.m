...
for k=1:Nb_iter_max
    ...
    % pour le co-support
    % (p_hat vaut toujours 0)
    z_hat=sigma_bi*gamma_bi*gradient(S_bar_hat);
...
%     f1=parfeval(pool,@gma_iteration_bi,2,S_hat,M,N,MN,tau_bi,mu_bi,b);
%     f2=parfeval(pool,@gma_iteration_re,2,p_til,S_til,S_bar_til,sigma_re,nsup1r1,nsup1r2,z_hat,sigma_bi,tau_re,gamma_re,mu_re,M,N,MN,b);
%     S_new_hat=fetchOutputs(f1);
%     [p_til,S_new_til]=fetchOutputs(f2);
    S_new_hat=gma_iteration_bi(S_hat,M,N,MN,tau_bi,mu_bi,b);
    [p_til,S_new_til]=gma_iteration_re(p_til,S_til,S_bar_til,sigma_re,nsup1r1,nsup1r2,z_hat,sigma_bi,tau_re,gamma_re,mu_re,M,N,MN,b);
