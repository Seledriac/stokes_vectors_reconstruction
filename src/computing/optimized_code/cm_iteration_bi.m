function [p_new_hat,S_new_hat]=cm_iteration_bi(norm1,norm2,nsup11,nsup12,nsup1r1,nsup1r2,S_hat,z_hat,M,N,MN,tau_bi,mu_bi,gamma_bi,b)
    ...
    p_new_hat(nsup1r2)=p_new_hat(nsup1r2)./repmat(norm2(nsup12),4,1,1);
