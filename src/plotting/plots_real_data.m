...
elseif ( strcmp(model_1,'ls') )
    fS_hat=matfile(strcat('../../data_out/ls/',data_source,'/S_hat_mu_bi_',sprintf('%.1f',mu_bi_1),'.mat'));
    S_model_1=fS_hat.S_hat;
elseif ( strcmp(model_1,'ls_r') )
    fS_til=matfile(strcat('../../data_out/ls/',data_source,'/S_til_mu_bi_',sprintf('%.1f',mu_bi_1),'_mu_re_',sprintf('%.1f',mu_re_1),'.mat'));
    S_model_1=fS_til.S_til;
end
